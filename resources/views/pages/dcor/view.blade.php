...
<body>
    <div class="container">
        <div class="no-print">
            ...
            <a href="{{ route('dcorDispatch',request('id')) }}">Dispatch</a>
            @endif
        </div>
        ...
        <table class="details">
            <tr>
                <td><strong>DC No:</strong> {{ $dc->dcor_number }}</td>
                <td><strong>Date:</strong> {{ \Carbon\Carbon::parse($dc->dcor_date)->format('d-m-Y') }}</td>
            </tr>
            <tr>
