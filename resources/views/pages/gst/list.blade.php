...
<div class="row">
    <div class="col-lg-12 d-flex justify-content-end">
        <a href="{{ route('gst.add') }}" class="btn btn-primary">Add GST</a>
    </div>
</div>
...
<tr>
    ...
    <td>{{ $gst->gst }}</td>
    <td>
        <a href="{{ route('gst.edit', $gst->id) }}" class="btn btn-primary">Edit</a>
        <form action="{{ route('gst.delete', $gst->id) }}" method="POST" style="display:inline;">
            @csrf
            @method('DELETE')
