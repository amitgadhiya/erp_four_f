...
@endsection
@section('content')
<form action="{{ route('row_item.add.post') }}" method="POST">
    @csrf
<div class="row">
    <div class="col-lg-3">
            ...
            <button type="submit" class="btn btn-primary">Edit Raw Item</button>
            <a href="{{ route('row_item.list') }}" class="btn btn-secondary">Cancel</a>
